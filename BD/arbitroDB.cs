...
namespace Administracion_Torneos.BD
{
    public class arbitroDB
    {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        arbitroo.Pago = reader.GetDecimal(9);
        ...
        public void Insertar_arbitro(Arbitro arbitro)
        {
            ...
            string query = "exec insertar_arbitros @DPI, @nombre,@apellido,@direccion,@telefono,@nacionalidad,@fechaNac,@correo,@rol,@Costo_Arbitraje ";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                SqlCommand sql = new SqlCommand(query, conexion);
                ...
                sql.Parameters.AddWithValue("@Costo_Arbitraje", arbitro.Pago);
        ...
        public void actualizar_arbitro(int? DPI, string Nombre, string Apellidos, string Direccion,string telefono,string Nacionalidad,DateTime FechaNac,string Correo,string Rol, decimal Costo_Arbitraje)
        {
            

            string query = "exec actualizar_arbitros @DPI, @nombre,@apellido,@direccion,@telefono,@nacionalidad,@fechaNac,@correo,@rol, @Costo_Arbitraje";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                command.Parameters.AddWithValue("@Costo_Arbitraje", Costo_Arbitraje);
