...
namespace Administracion_Torneos.Vista
{
    public partial class TorneoCRUD : Form
    {
        ...
        public int bitacora;
        public TorneoCRUD(int id_bitacora,int id_user)
        {
            ...
            if (accion == 1)
            {
                if (preciotorneo.Value > 0)
                {
                    ...
                    if (cmbcategoria.SelectedIndex >= 0 && cmbjugadores.SelectedIndex >= 0)
                    {
                        ...
                        this.Hide();
                        TorneoCRUD t = new TorneoCRUD(bitacora,id_usuario);
                        t.Show();
        ...
        private void aggequipos_Click(object sender, EventArgs e)
        {
            ...
            ViewEquipo vq = new ViewEquipo(bitacora, id_usuario);
            vq.Show();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (prlist.Count == 0)
            {
                this.Hide(); // de momento sirve de transcicion a equipos
                int? idtorneo = GetId();
                ListaEquipo vq = new ListaEquipo(Convert.ToInt32(idtorneo), getEdadMinima(), getEdadMaxima(),bitacora,id_usuario);
                vq.Show();
            }
            else
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                Partidos pr = new Partidos(id, bitacora, id_usuario);
