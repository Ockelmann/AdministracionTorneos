...
namespace Administracion_Torneos.Vista
{
    public partial class ViewPosicionJugador : Form
    {
        ...
        public int id_bitacora, usuario;
        public ViewPosicionJugador(int idTorneo, int idEquipo, int edadMinima, int edadMaxima, int bitacora, int user)
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            ListaEquipo eq = new ListaEquipo(idTorneo, edadMinima, edadMaxima, id_bitacora, usuario);
            eq.Show();
        ...
        public int getIdentificacion()
        {
            try
            {
                return int.Parse(listJugadores.Rows[listJugadores.CurrentRow.Index].Cells[2].Value.ToString());
            }
            catch
            {
                return 0;
