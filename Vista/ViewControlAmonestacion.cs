...
namespace Administracion_Torneos.Vista
{
    public partial class ViewControlAmonestacion : Form
    {
        ...
        public int id_usuario, bitacora;


        public ViewControlAmonestacion(int minutos, int idPartido, int idTorneo,int id_bitacora, int id_user)
        {
            InitializeComponent();
        ...
        {
            Partidos partidos = new Partidos(idTorneo,bitacora, id_usuario);
            partidos.Show();
        }
