...
namespace Administracion_Torneos.Vista
{
    public partial class ViewEntrenador : Form
    {
        ...
        public int bitacora;
        public ViewEntrenador(int id_bitacora, int id_user)
        {
            InitializeComponent();
            id_usuario = id_user;
        ...
        {
            ViewEquipo viewEquipo = new ViewEquipo(bitacora, id_usuario);
            viewEquipo.Show();
        }
        ...
        public long getDPI()
        {
            try
            {
                return long.Parse(listEntrenadores.Rows[listEntrenadores.CurrentRow.Index].Cells[0].Value.ToString());
            }
            catch
            {
                return 0;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (!(string.IsNullOrEmpty(cbxEquipo.Text) || 
                ...
                entrenador.dpi = Convert.ToInt64(txtDPI.Text);
