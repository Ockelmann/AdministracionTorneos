...
namespace Administracion_Torneos.Vista
{
    public partial class Partidos : Form
    {
        ...
        public Partidos(int? idtorneo,int bitacora, int id_user)
        {
...
if (prrContext.Jornadas(ids).marcador_local == local.Value && visita.Value == prrContext.Jornadas(ids).marcador_visita
        ...
        {
            horainicio.MaxDate = Convert.ToDateTime("31/12/9998");
            horafin.MaxDate = Convert.ToDateTime("31/12/9998");
            horainicio.MinDate = Convert.ToDateTime("31/12/1900");
            horafin.MinDate = Convert.ToDateTime("31/12/1900");

            fecha.Value = Convert.ToDateTime(fecha.Value.Day + "/" + fecha.Value.Month + "/" + fecha.Value.Year + " 23:59:59");
            horainicio.MaxDate = fecha.Value;
            horafin.MaxDate = fecha.Value;
            horainicio.MinDate = fecha.Value.Date;
            horafin.MinDate = fecha.Value.Date;
        ...
        {
            this.Hide();
            TorneoCRUD tr = new TorneoCRUD(id_bitacora, id_usuario);
            tr.Show();
        }
        ...
        private void accionespopartido_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                horainicio.Value = prrContext.Jornadas(ids).hora_inicio;

                horafin.Value = prrContext.Jornadas(ids).hora_fin;
                ...
                switch ( accionespopartido.SelectedIndex)
                {
                    case 0:
                            ...
                            this.Hide();
                            controlgoles ctrg = new controlgoles(Convert.ToInt32(minutos), Convert.ToInt32(ids),id_bitacora, id_usuario);
                            ctrg.Show();
                    ...
                    case 1:
                        this.Hide();
                        ViewControlAmonestacion viewControlAmonestacion = new ViewControlAmonestacion(Convert.ToInt32(minutos), Convert.ToInt32(ids), Convert.ToInt32(id), id_bitacora, id_usuario);
                        viewControlAmonestacion.Show();
                        
                        break;
                    case 2:
                        this.Hide();
                        ViewCambio vrc = new ViewCambio(Convert.ToInt32(minutos), Convert.ToInt32(ids), Convert.ToInt32(id), id_bitacora,id_usuario);
                        vrc.Show();
                        break;

                    case 3:
                        this.Hide();
                        VistaControlArbitro vistaControlArbitro = new VistaControlArbitro(Convert.ToInt32(ids), Convert.ToInt32(id), id_bitacora, id_usuario);
