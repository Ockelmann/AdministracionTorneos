...
{
    public partial class Reporte_IngresoArbitros : Form
    {
        ...
        public int usuario;
        public int bitacora;
        public Reporte_IngresoArbitros(int id_bitacora, int id_user)
        {
            InitializeComponent();
            usuario = id_user;
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string query = "EXEC REPORTE_INGRESO_ARBITRO '" + inicio + "','" + fin + "'";
            GetIngresos(query);
        }
        ...
        private void Reporte_IngresoArbitros_FormClosing(object sender, FormClosingEventArgs e)
        {
