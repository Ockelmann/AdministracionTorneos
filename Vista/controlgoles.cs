...
namespace Administracion_Torneos.Vista
{
       ...
       
    {
        ...
        public controlgoles(int tiempo , int id,int bitacora, int id_user)
        {
            ids = id;
            InitializeComponent();
        ...
        {
            this.Hide();
            Partidos pr = new Partidos(prrcontext.Jornadas(ids).id_torneo, id_bitacora, id_usuario); // regresamos  la vista de partidos 
            pr.Show();
        }
