...
(
	...
	Costo_Arbitraje DECIMAL(8,2) NOT NULL,
	PRIMARY KEY(DPI)
);
go
...
CREATE TABLE BITACORA(
	...
	TORNEO BIT DEFAULT 0 NOT NULL,
	EQUIPO BIT DEFAULT 0 NOT NULL,
	ENTRENADOR BIT DEFAULT 0 NOT NULL,
	USUARIOS BIT DEFAULT 0 NOT NULL,
	ARBITROS BIT DEFAULT 0 NOT NULL,
	AMONESTACIONES BIT DEFAULT 0 NOT NULL,
	PAGO_AMONESTACIONES BIT DEFAULT 0 NOT NULL,
	CLIENTES BIT DEFAULT 0 NOT NULL,
	JUGADORES BIT DEFAULT 0 NOT NULL,
	CANCHAS BIT DEFAULT 0 NOT NULL,
	REPORTES BIT DEFAULT 0 NOT NULL,
	ALQUILER_CANCHA BIT DEFAULT 0 NOT NULL,
	PRIMARY KEY (ID),
...
(
	...
	Fecha_Apartada DATETIME NOT NULL,
	Hora_Inicio DATETIME NOT NULL,
	Hora_Final DATETIME NOT NULL,
	Total_Precio decimal(8,2) Not NULL,
	PRIMARY KEY (ID),
	CONSTRAINT FK_NOCANCHA FOREIGN KEY (NoCancha) REFERENCES CANCHA (NoCancha),
	CONSTRAINT FK_IDCLIENTE FOREIGN KEY (ID_CLIENTE) REFERENCES CLIENTE (ID_CLIENTE)
);
GO

CREATE TABLE ALQUILE_ARBITRO(
	ID INT NOT NULL IDENTITY (1,1),
	...
	Total_Precio_Arbitro decimal(8,2) DEFAULT 0,
	PRIMARY KEY (ID),
